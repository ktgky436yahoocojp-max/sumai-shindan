    ...
    <div style={styles.bg}>
      <div style={{...styles.card, maxWidth: 680}}>
        ...
        <div style={styles.section}>
          ...
          {detectedTypes.length > 0 ? detectedTypes.map(t => (
            ...
            <div style={{...styles.typeCard, borderColor:"#86efac", background:"#f0fdf4"}}>
              <div style={{...styles.typeName, color:"#16a34a"}}>✅ 大きなリスクタイプは検出されませんでした</div>
              <p style={styles.typeDesc}>現時点では重大なリスクの組み合わせは見られません。スコアが低い項目は継続的に注意が必要です。</p>
            </div>
          )}
        </div>
        <div style={styles.section}>
        ...
        <div style={styles.lineCtaBox}>
          ...
          <a href="https://line.me/R/ti/p/@148cciyn" style={styles.lineBtn}>
...
const styles = {
  ...
  title: { fontSize: 28, fontWeight: 700, lineHeight: 1.4, margin: "0 0 12px", color: "#0f172a" },
  subtitle: { fontSize: 14, color: "#475569", lineHeight: 1.8, margin: "0 0 20px" },
  infoRow: { display: "flex", gap: 10, flexWrap: "wrap", marginBottom: 28 },
  infoItem: { fontSize: 13, color: "#334155", background: "#f1f5f9", border: "1px solid #e2e8f0", padding: "6px 12px", borderRadius: 8 },
  startBtn: { width: "100%", padding: "16px", background: "linear-gradient(135deg, #0ea5e9, #0284c7)", color: "#fff", border: "none", borderRadius: 12, fontSize: 16, fontWeight: 700, cursor: "pointer", letterSpacing: "0.05em", boxShadow: "0 4px 12px rgba(14,165,233,0.3)" },
  note: { textAlign: "center", fontSize: 11, color: "#94a3b8", marginTop: 12 },
  progressWrap: { display: "flex", alignItems: "center", gap: 10, marginBottom: 24 },
  progressBar: { flex: 1, height: 8, background: "#e2e8f0", borderRadius: 999, overflow: "hidden" },
  progressFill: { height: "100%", background: "linear-gradient(90deg, #0ea5e9, #38bdf8)", borderRadius: 999, transition: "width 0.3s" },
  progressText: { fontSize: 12, color: "#64748b", whiteSpace: "nowrap" },
  catHeader: { display: "flex", alignItems: "center", gap: 12, background: "#f0f9ff", border: "1px solid #bae6fd", borderRadius: 12, padding: "12px 16px", marginBottom: 20 },
  catIcon: { fontSize: 24 },
  catName: { fontSize: 15, fontWeight: 700, color: "#0369a1" },
  catDesc: { fontSize: 12, color: "#64748b", marginTop: 2 },
  qBox: { marginBottom: 20 },
  qNum: { fontSize: 11, color: "#94a3b8", marginBottom: 8, letterSpacing: "0.05em" },
  qText: { fontSize: 17, fontWeight: 600, lineHeight: 1.6, color: "#0f172a" },
  optionList: { display: "flex", flexDirection: "column", gap: 8, marginBottom: 16 },
  optionBtn: { display: "flex", alignItems: "center", gap: 10, padding: "13px 16px", background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 10, color: "#334155", fontSize: 14, cursor: "pointer", textAlign: "left" },
  optionSelected: { background: "#e0f2fe", border: "1px solid #38bdf8", color: "#0369a1", fontWeight: 600 },
  optionDot: { fontSize: 12, color: "#94a3b8", minWidth: 20 },
  backBtn: { background: "none", border: "none", color: "#94a3b8", fontSize: 13, cursor: "pointer", padding: "4px 0" },
  scoreCircle: { textAlign: "center", padding: "8px 0" },
  scoreNum: { fontSize: 64, fontWeight: 800, lineHeight: 1 },
  scoreLabel: { fontSize: 18, color: "#94a3b8", marginLeft: 4 },
  scoreGrid: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, margin: "16px 0" },
  scoreItem: { background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 10, padding: "10px 12px" },
  ...
  scoreBar: { height: 5, background: "#e2e8f0", borderRadius: 999, overflow: "hidden" },
  scoreBarFill: { height: "100%", borderRadius: 999, transition: "width 0.5s" },
  section: { marginTop: 24 },
  sectionTitle: { fontSize: 15, fontWeight: 700, color: "#334155", marginBottom: 12 },
  typeCard: { border: "1px solid #fca5a5", background: "#fff5f5", borderRadius: 12, padding: "16px", marginBottom: 10 },
  typeName: { fontSize: 15, fontWeight: 700, color: "#dc2626", marginBottom: 6 },
  typeDesc: { fontSize: 13, color: "#475569", lineHeight: 1.7, margin: "0 0 10px" },
  strategyList: { display: "flex", flexDirection: "column", gap: 4 },
  strategyItem: { fontSize: 13, color: "#334155", paddingLeft: 4 },
  topPickCard: { background: "linear-gradient(135deg, #e0f2fe, #f0f9ff)", border: "2px solid #0ea5e9", borderRadius: 14, padding: "20px", marginBottom: 16, boxShadow: "0 4px 16px rgba(14,165,233,0.15)" },
  topPickBadge: { display: "inline-block", background: "#0ea5e9", color: "#fff", fontSize: 11, fontWeight: 700, padding: "4px 12px", borderRadius: 999, marginBottom: 12, letterSpacing: "0.06em" },
  topPickInner: { display: "flex", alignItems: "center", gap: 14 },
  topPickEmoji: { fontSize: 36, lineHeight: 1 },
  topPickLabel: { fontSize: 20, fontWeight: 800, color: "#0369a1", marginBottom: 4 },
  topPickDesc: { fontSize: 13, color: "#0284c7", lineHeight: 1.6 },
  otherLabel: { fontSize: 11, color: "#94a3b8", letterSpacing: "0.08em", marginBottom: 8, paddingLeft: 2 },
  strategyCard: { display: "flex", alignItems: "flex-start", gap: 12, padding: "12px 14px", background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 10, marginBottom: 8 },
  strategyEmoji: { fontSize: 22, lineHeight: 1.2 },
  strategyLabel: { fontSize: 14, fontWeight: 700, color: "#1e293b", marginBottom: 2 },
  strategyDesc: { fontSize: 12, color: "#64748b" },
  lineCtaBox: { background: "linear-gradient(135deg, #f0fdf4, #dcfce7)", border: "2px solid #4ade80", borderRadius: 16, padding: "20px", marginTop: 28, marginBottom: 12 },
  lineCtaText: { marginBottom: 14 },
  lineCtaTitle: { fontSize: 15, fontWeight: 700, color: "#15803d", marginBottom: 6 },
  lineCtaDesc: { fontSize: 13, color: "#166534", lineHeight: 1.6 },
  lineBtn: { display: "flex", alignItems: "center", justifyContent: "center", gap: 8, width: "100%", padding: "14px", background: "#06c755", color: "#fff", border: "none", borderRadius: 12, fontSize: 15, fontWeight: 700, cursor: "pointer", textDecoration: "none", boxSizing: "border-box", boxShadow: "0 4px 12px rgba(6,199,85,0.3)" },
  lineBtnIcon: { fontSize: 18 },
  lineNote: { textAlign: "center", fontSize: 12, color: "#166534", marginTop: 10 },
};
